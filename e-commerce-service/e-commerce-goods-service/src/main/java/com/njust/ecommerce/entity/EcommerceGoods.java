...
import com.njust.ecommerce.converter.BrandCategoryConverter;
import com.njust.ecommerce.converter.GoodsCategoryConverter;
import com.njust.ecommerce.converter.GoodsStatusConverter;
...
public class EcommerceGoods {
    ...
    public static EcommerceGoods to(GoodsInfo goodsInfo) {
        ...
        ecommerceGoods.setInventory(goodsInfo.getSupply()); //这里库存量就是供应量
