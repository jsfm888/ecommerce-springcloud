...
public class SwaggerConfig {
    ...
    public Docket docket() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                // 选择展示哪些接口
                .select()
                // 只有 com.njust.ecommerce 包内的才去展示
                .apis(RequestHandlerSelectors.basePackage("com.njust.ecommerce"))
    ...
    public ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
                .title("njust-micro-service")
                .description("e-commerce-springcloud-service")
                .contact(new Contact(
                        "Jsfm", "www.jsfm888.com/", "qinwenqiang_8@163.com"
                ))
                .version("1.0")
                .build();
    }
